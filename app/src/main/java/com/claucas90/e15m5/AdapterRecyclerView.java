...
//clase para entregar los valores en lista del mismo tipo, puede tener la cantidad de parametros que queramos
data class TuModeloDeDatos(val items: String)

//el daptador donde va la lista y la funcion de estructura
class AdapterRecyclerView(private val datos:List<TuModeloDeDatos>) : RecyclerView.Adapter<AdapterRecyclerView.TuViewHolder>() {

        //funcion donde se toma el layout de estructura
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TuViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_layout, parent, false)
        return TuViewHolder(view)
        }

        //para cargar la estructura la cantidad de veces que uno quiera segun el largo de la lista entregada de datos
        ...
        //adaptador de la estructura a los datos
